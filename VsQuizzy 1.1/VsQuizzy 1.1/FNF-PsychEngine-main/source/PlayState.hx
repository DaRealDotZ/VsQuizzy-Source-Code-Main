...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'forest': //Week Q
			    var nightSky:BGSprite = new BGSprite('nightSky', -600, -200, 0.9, 0.9);
			    add(nightSky);

				var wall:BGSprite = new BGSprite('wall', -600, -200, 0.9, 0.9);
			    add(wall);

				var forestFront:BGSprite = new BGSprite('forestGround', -600, -200, 0.9, 0.9);
		...
		if (isStoryMode && !seenCutscene)
		{
			switch (daSong)
			{
				...
				case 'goal' | 'clash' | 'smiling-rampage' | 'gambit':
